...
LuaTele = luatele.set_config{api_id=14471516,api_hash='94a6d01e235a29c5f8032f942011095d',session_name=BRAND,token=Token}
LUATELE = URL.escape(""..BRAND.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
function var(value)  
...
elseif UserId == BRAND then Status = true
...
if Redis:sismember(BRAND.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
...
local msg_id = msg.id
--var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(BRAND.."Lock:channell"..msg_chat_id) then
print(Redis:get(BRAND.."chadmin"..msg_chat_id))
...
{{text = '• سورس براند •', url = 't.me/CXRCX'}, },}}
--]]
keyboard = {} 
...
Redis:sadd(BRAND.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(BRAND.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(BRAND.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(BRAND.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(BRAND.."Supcreator:Group"..idg,idASAS)
end;end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'-  عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(BRAND..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
Get_Is_Id = Redis:get(BRAND.."Set:Id:Group"..msg_chat_id) or Redis:get(BRAND.."Set:Id:Groups")
...
local TotalMsg = Redis:get(BRAND..'Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(BRAND..'Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
...
local TotalMsg = Redis:get(BRAND..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(BRAND..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
'\n⋄︙User Name ↬ @'..UserName..
...
local vip = Redis:smembers(BRAND.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(BRAND.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(BRAND.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(BRAND.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(BRAND.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(BRAND.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(BRAND.."Dev:Groups") 
local devss = Redis:smembers(BRAND.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
TheBasics = Redis:sismember(BRAND.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(BRAND.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(BRAND.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(BRAND.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(BRAND.."Special:Group"..msg.chat_id,UserId_Info.id)
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(BRAND.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(BRAND.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(BRAND.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(BRAND.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(BRAND.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
...
if Jabwa.first_name then
BRANDusername = '*طلب ↫ *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من ↫ *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
BRANDusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,BRANDusername,"md",false, false, false, false, reply_markup)
end
...
Redis:del(BRAND.."sayy"..msg_chat_id)
...
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(BRAND.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:smembers(BRAND.."Supcreator:Group"..msg_chat_id) then
Redis:del(BRAND.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(BRAND.."Creator:Group"..msg_chat_id) then
Redis:del(BRAND.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(BRAND.."Manger:Group"..msg_chat_id) then
Redis:del(BRAND.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(BRAND.."Admin:Group"..msg_chat_id) then
Redis:del(BRAND.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(BRAND.."Special:Group"..msg_chat_id) then
...
LuaTele.sendText(msg_chat_id,msg_id,'-  عدد رسائلك هنا*~ '..(Redis:get(BRAND..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'-  عدد التعديلات هنا*~ '..(Redis:get(BRAND..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'-  عدد جهاتك المضافه هنا*~ '..(Redis:get(BRAND.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/BRANDb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(BRAND.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if not Redis:sismember(BRAND.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* -   لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(BRAND.."Add:Rd:array:Text"..gery..msg_chat_id,text)
...
Redis:del(BRAND.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(BRAND..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* -   لا يوجد رد متعدد* ',"md",true)
return false
end
...
Redis:sadd(BRAND.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:del(BRAND.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(BRAND..'List:array'..msg_chat_id, text)
...
if text then
if  Redis:sismember(BRAND..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(BRAND.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(BRAND..'List:array'..msg_chat_id..'')
...
local TextingDevBRAND = Redis:get(BRAND..'Texting:DevBRAND')
...
---زخرفة ----
if Redis:get(BRAND.."toen"..msg.sender.user_id) == "on" then
...
if Redis:get(BRAND.."toar"..msg.sender.user_id) == "on" then
...
if Redis:get(BRAND.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if text and Redis:get(BRAND..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(BRAND..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(BRAND..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
keyboard.inline_keyboard = {
{
{text = '𝐃𝐞𝐯: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/YYCCCC"},{text = '𝐂𝐡: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/CXRCX"},
},
{
{text = '𝐄𝐱𝐩 𝐒𝐨𝐮𝐫𝐜𝐞', url = "http://t.me/cxrcx"}
},
}
...
download('https://raw.githubusercontent.com/BBHXX/BRAND/master/','BRAND.lua')
...
Redis:incrby(BRAND.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
local CmdStart = '\n⋄︙مرحبا انا بوت '..(Redis:get(BRAND.."Name:Bot") or "براند")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(BRAND.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
return LuaTele.sendText(msg_chat_id,msg_id,'-  ︙اهلا بك مجددا عزيزي المطور \n-  ︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس براند فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'رجـوع - ',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'-  ︙اهلا بك مجددا عزيزي المطور \n-  ︙اليك الازرار الخاصه ب أحصائيات  سورس براند فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء - ',type = 'text'},},
{{text = 'رجـوع - ',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'-  ︙اهلا بك مجددا عزيزي المطور \n-  ︙اليك الازرار الخاصه ب المطورين لسورس براند فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء - ',type = 'text'},},
{{text = 'رجـوع - ',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'-  ︙اهلا بك مجددا عزيزي المطور \n-  ︙اليك الازرار الخاصه بالاذاعه لسورس براند فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء - ',type = 'text'},},
{{text = 'رجـوع - ',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'-  ︙اهلا بك مجددا عزيزي المطور \n-  ︙اليك الازرار الخاصه بالعام لسورس براند فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء - ',type = 'text'},},
{{text = 'رجـوع - ',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'-  ︙اهلا بك مجددا عزيزي المطور \n-  ︙اليك الازرار الخاصه ببوتك المثبت علئ لسورس براند فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
--     Source BRAND     --
--     end start chat Pv     --
if text == 'تنظيف المشتركين - ' then
...
reply_markup = {
inline_keyboard ={
{{text ="• BRAND Source", url= "https://t.me/CXRCX"}},
}
},
},
}
...
elseif Redis:sismember(BRAND.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(BRAND.."Supcreator:Group"..ChatId,IdUser) == true then
...
if Redis:sismember(BRAND.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."Supcreator:Group"..ChatId,UserId[2])
end
...
local Info_Members = Redis:smembers(BRAND.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BRAND.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BRAND.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BRAND.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BRAND.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BRAND.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
if tonumber(IdUser) == tonumber(UserId[1]) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'سورس براند', url = 't.me/CXRCX'}, },}}
...
local UserId = {Text:match('(%d+)/statusTheBasicsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BRAND.."BRAND:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."BRAND:TheBasics:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusOriginatorsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(BRAND.."BRAND:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."BRAND:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusManagersz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BRAND.."BRAND:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:Managers:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."BRAND:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusAddictivez/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BRAND.."BRAND:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:Addictive:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."BRAND:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusDistinguishedz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(BRAND.."BRAND:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:Distinguished:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."BRAND:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(BRAND.."BRAND:Originators:Group"..ChatId,UserId[2])
Redis:srem(BRAND.."BRAND:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(BRAND.."BRAND:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(BRAND.."BRAND:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(BRAND.."BRAND:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(BRAND.."BRAND:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'banned',0)
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
...
if Redis:sismember(BRAND.."BRAND:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(BRAND.."BRAND:SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(BRAND.."BRAND:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:set(BRAND.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ BRAND',url='http://t.me/CXRCX'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ BRAND',url='http://t.me/CXRCX'}},}
...
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"تعط")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"تفع")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"ا")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"م")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"اد")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"مد")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"من")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"اس")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'مط','رفع مطور')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"مط")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'ثانوي','رفع مطور ثانوي')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"ثانوي")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'تك','تنزيل الكل')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"تك")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"ر")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"رر")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"رد")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"سح")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"رس")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"غ")
Redis:set(BRAND.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(BRAND.."Command:List:Group"..ChatId,"#")
local txxt = [[
-  تم ترتيب الاوامر بالشكل التالي ~
-   ايدي - ا .
-   رفع مميز - م .
...
BRANDusername = '*تم الزواج بنجاح \nمبروك  يا  ↫ *['..bain.first_name..'](tg://user?id='..bain.id..' *\n*'
else
BRANDusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,BRANDusername, 'md', true, false, reply_markup)
end
end
